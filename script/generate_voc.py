...
cPickle.dump(uid_voc, open("uid_voc_large.pkl", "w"))
cPickle.dump(mid_voc, open("mid_voc_large.pkl", "w"))
cPickle.dump(cat_voc, open("cat_voc_large.pkl", "w"))
