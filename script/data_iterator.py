            ...
            while True:
                ...
                for i in range(len(time_list)):
                    ...
                    if deltatime_now <= 0.5:
                        deltatime_now = 0.5
                    tmp4.append(math.log(deltatime_now))
                timenow_list = tmp4
                ...
                for i in range(len(time_list)-1):
                    ...
                    if deltatime_last <= 0.5:
                        deltatime_last = 0.5
                    tmp5.append(math.log(deltatime_last))
                ...
                source.append([uid, mid, cat, mid_list, cat_list, noclk_mid_list, noclk_cat_list, time_list, timelast_list, timenow_list])
